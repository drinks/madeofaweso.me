...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'SocialNetwork.url'
        db.alter_column('lifestream_socialnetwork', 'url', self.gf('django.db.models.fields.URLField')(default='', max_length=200))


    def backwards(self, orm):
        
        # Changing field 'SocialNetwork.url'
        db.alter_column('lifestream_socialnetwork', 'url', self.gf('django.db.models.fields.URLField')(max_length=200, null=True))
    ...
    models = {
        'lifestream.behanceaccount': {
            ...
            'network': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['lifestream.SocialNetwork']"}),
        ...
        'lifestream.behanceitem': {
            ...
            'thumbnail': ('sorl.thumbnail.fields.ImageField', [], {'max_length': '100'}),
