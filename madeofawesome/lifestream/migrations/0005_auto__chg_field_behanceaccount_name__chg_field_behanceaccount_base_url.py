...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'BehanceAccount.name'
        db.alter_column('lifestream_behanceaccount', 'name', self.gf('django.db.models.fields.CharField')(max_length=255, null=True))

        # Changing field 'BehanceAccount.base_url'
        db.alter_column('lifestream_behanceaccount', 'base_url', self.gf('django.db.models.fields.URLField')(max_length=200, null=True))

        # Changing field 'BehanceAccount.remote_url'
        db.alter_column('lifestream_behanceaccount', 'remote_url', self.gf('django.db.models.fields.URLField')(max_length=200, null=True))


    def backwards(self, orm):
        
        # Changing field 'BehanceAccount.name'
        db.alter_column('lifestream_behanceaccount', 'name', self.gf('django.db.models.fields.CharField')(default='', max_length=255))

        # Changing field 'BehanceAccount.base_url'
        db.alter_column('lifestream_behanceaccount', 'base_url', self.gf('django.db.models.fields.URLField')(default='', max_length=200))

        # Changing field 'BehanceAccount.remote_url'
        db.alter_column('lifestream_behanceaccount', 'remote_url', self.gf('django.db.models.fields.URLField')(default='', max_length=200))
    ...
    models = {
        'lifestream.behanceaccount': {
            ...
            'base_url': ('django.db.models.fields.URLField', [], {'max_length': '200', 'null': 'True', 'blank': 'True'}),
