...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'BehanceAccount.remote_url'
        db.delete_column('lifestream_behanceaccount', 'remote_url')


    def backwards(self, orm):
        
        # Adding field 'BehanceAccount.remote_url'
        db.add_column('lifestream_behanceaccount', 'remote_url', self.gf('django.db.models.fields.URLField')(max_length=200, null=True, blank=True), keep_default=False)
