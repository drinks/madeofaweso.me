...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'BehanceAccount.network'
        db.add_column('lifestream_behanceaccount', 'network', self.gf('django.db.models.fields.related.ForeignKey')(default=0, to=orm['lifestream.SocialNetwork']), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'BehanceAccount.network'
        db.delete_column('lifestream_behanceaccount', 'network_id')
